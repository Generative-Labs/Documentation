...
export default [
  ...
  },
  {
    ...
    routes: [
      ...
      {
        path: '/docs/Web3MQ-SDK/DappConnect-SDK/client',
        component: ComponentCreator('/docs/Web3MQ-SDK/DappConnect-SDK/client','2ca'),
        exact: true,
        'sidebar': "tutorialSidebar"
      },
      {
        path: '/docs/Web3MQ-SDK/DappConnect-SDK/intro',
        component: ComponentCreator('/docs/Web3MQ-SDK/DappConnect-SDK/intro','111'),
        exact: true,
        'sidebar': "tutorialSidebar"
      },
      {
        path: '/docs/Web3MQ-SDK/DappConnect-SDK/quickstart',
        component: ComponentCreator('/docs/Web3MQ-SDK/DappConnect-SDK/quickstart','152'),
        exact: true,
        'sidebar': "tutorialSidebar"
      },
      {
        path: '/docs/Web3MQ-SDK/DappConnect-SDK/typeList',
        component: ComponentCreator('/docs/Web3MQ-SDK/DappConnect-SDK/typeList','305'),
        exact: true,
        'sidebar': "tutorialSidebar"
      },
      {
