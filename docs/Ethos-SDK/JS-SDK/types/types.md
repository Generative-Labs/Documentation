...
| connectUrl | string \| null                                      | [Web3MQAPiEndpoints](/docs/Ethos-SDK/JS-SDK/standards/#web3mq-api-endpoints)                         | takes in a valid endpoint url as input, when this paramter is given, client will always connect to that specific node | `https://testnet-ap-jp-2.web3mq.com` |
